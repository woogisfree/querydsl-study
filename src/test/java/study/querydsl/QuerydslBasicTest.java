...
public class QuerydslBasicTest {
    ...
    @Test
    void searchWithParam() throws Exception {
        Member findMember = queryFactory
                .selectFrom(member)
                .where(
    ...
    /**
     * case문은 application 단에서 해결하는 것이 좋음
     */
    @Test
    ...
    /**
     * Tuple 은 Service, Controller 로 넘기는 건 유지보수를 관점에서 좋은 방법이 아니다. DTO 로 변환해서 보내자.
     */
    @Test
    ...
    private List<Member> searchMember1(String usernameCond, Integer ageCond) {
        ...
        //BooleanBuilder 의 생성자 파라미터에 초기값을 넣을 수 있음
...
//    @Commit
    void bulkUpdate() throws Exception {
        ...
        /**
         * DB에서 가져온 값보다 영속성 컨텍스트의 값이 우선권을 가지기 때문에 DB에서 select 해온 값이 무시됨.
         * 그러므로 벌크 연산시 반드시 flush clear 로 영속성컨텍스트 초기화가 필요함
         */
        em.flush();
        em.clear();
